...
\begin{frame}[fragile]{Challanges with the data}
	\begin{itemize}
		\item In the training data we have input file and output file, where input has the coordinates and output has object names and the count of the each object.
		\item But there are no annotations i.e., we don't exactly know which points belong to which object.

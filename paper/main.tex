...
One of the special and still not well-solved problems in robotics research, is the real-time object recognition surrounding an autonomous robot in rapidly changing environment.  Many applications like autonomous vehicles require object recognition in real-time with high accuracy. 

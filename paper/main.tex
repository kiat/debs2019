...
\begin{enumerate}
  ...
  \item A brief discussion about lessons learned by designing and implementing such object detection system 
  \item Future extensions of our implementation (Sec. \ref{sec:conclusion} )
\end{enumerate}    

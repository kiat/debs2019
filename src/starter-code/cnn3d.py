...
class ClassifyWith3dCnn(object):
    def __init__(self, X_train, y_train, X_test, y_test, num_classes):
        ...
        self.X_train = self.X_train.reshape(X_train.shape[0], 16, 16, 16, 3)
        self.X_test = self.translate(X_test)
        self.X_test = self.X_test.reshape(X_test.shape[0], 16, 16, 16, 3)

        self.y_train = y_train
        self.y_test = y_test

        self.model = self.CNN((16, 16, 16, 3), self.num_classes)
